...
> **TL;DR**: After auditing ~300KB of source code from 9 mainstream agent frameworks ([OpenAI Agents SDK](deep-dive/OpenAI-Agents-SDK-DEEP-DIVE.md), [Claude Agent SDK](deep-dive/Claude-Agent-SDK-Python-DEEP-DIVE.md), [Codex CLI](deep-dive/Codex-CLI-DEEP-DIVE.md), [OpenCode](deep-dive/OpenCode-DEEP-DIVE.md), [Kimi CLI](deep-dive/Kimi-CLI-DEEP-DIVE.md), [Gemini CLI](deep-dive/Gemini-CLI-DEEP-DIVE.md), [Qwen Code](deep-dive/Qwen-Code-DEEP-DIVE.md), [SWE-agent](deep-dive/SWE-agent-DEEP-DIVE.md), [OpenManus](deep-dive/OpenManus-DEEP-DIVE.md)), we discovered a counter-intuitive fact: **The core Agent Loop logic is highly similar across frameworks**. The real differences lie in **"Capability Differentiation"** — 30+ engineering features like state management, security controls, and protocol support. This differentiation creates an invisible gap between academia and industry.

> **Navigation**:
> - Sections 1-3: Code audit observations (facts)
> - Section 4: Academic vs. industrial capability requirements (facts + inference)
> - Section 5: Future convergence trends (author's judgment)
> - Section 6: Framework selection guide (actionable)
...
**AI Assistance**: This research and blog were created with the assistance of [Opencode](https://opencode.ai), an AI-powered software engineering assistant. Opencode helped analyze ~300KB of source code and generate documentation.

**Methodology**: All technical details are based on actual source code audits. Specific file paths and line numbers can be verified in the framework-specific deep dive reports in [deep-dive/](deep-dive/).

**Feedback and Contributions**: Issues and PRs are welcome for corrections or additional framework analyses.
