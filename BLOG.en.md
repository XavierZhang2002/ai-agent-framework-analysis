...
> **TL;DR**: After auditing ~400KB of source code from 12 mainstream agent frameworks ([OpenAI Agents SDK](deep-dive/OpenAI-Agents-SDK-DEEP-DIVE.md), [Claude Agent SDK](deep-dive/Claude-Agent-SDK-Python-DEEP-DIVE.md), [Codex CLI](deep-dive/Codex-CLI-DEEP-DIVE.md), [OpenCode](deep-dive/OpenCode-DEEP-DIVE.md), [Kimi CLI](deep-dive/Kimi-CLI-DEEP-DIVE.md), [Gemini CLI](deep-dive/Gemini-CLI-DEEP-DIVE.md), [Qwen Code](deep-dive/Qwen-Code-DEEP-DIVE.md), [SWE-agent](deep-dive/SWE-agent-DEEP-DIVE.md), [OpenManus](deep-dive/OpenManus-DEEP-DIVE.md), [Aider](deep-dive/Aider-DEEP-DIVE.md), [Goose](deep-dive/Goose-DEEP-DIVE.md), [OpenHands](deep-dive/OpenHands-DEEP-DIVE.md)), we discovered a counter-intuitive fact: **The core Agent Loop logic is highly similar across frameworks**. The real differences lie not in "which algorithm is used," but in **engineering capability combinations**—35+ features including state management, security controls, protocol support, LSP support, and Project Memory. This "capability differentiation" creates an invisible gap, making it difficult for academia to leverage the most advanced agent capabilities.
>
> **Market Landscape Update**: Based on GitHub Stars, the first tier ("Big Four") is: **OpenCode** (97.5K) > **Gemini CLI** (93.6K) > **Claude Code** (64K) > **Codex CLI** (59K). The power of the open-source community is redefining the standards for Agent tools.
